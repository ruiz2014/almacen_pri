...
class CreditController extends Controller
{
    ...
    //     return view('credit.create', compact('attention'));
    // }
    ...
    public function store(AttentionRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('credits.index')
            ->with('success', 'La Venta de credito fue Actualizada a pagada.');
    }
    ...
    //     return view('credit.show', compact('attention'));
    // }
    ...
    //     return view('credit.edit', compact('attention'));
    // }
